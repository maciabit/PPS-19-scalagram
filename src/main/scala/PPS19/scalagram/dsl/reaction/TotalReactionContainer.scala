...
case class TotalReactionContainer(reactions: List[Reaction]) extends ReactionContainer {
  ...
  /** Creates a [[PartialReactionContainer]] with all the reactions from this container,
    * plus a partial [[OnMessage]] reaction that matches any message.
    *
  ...
  /** Creates a [[PartialReactionContainer]] with all the reactions from this container,
    * plus a partial [[OnMessage]] reaction that matches a single message.
    *
  ...
  /** Creates a [[PartialReactionContainer]] with all the reactions from this container,
    * plus a partial [[OnMessage]] reaction that matches a list of messages.
    *
  ...
  /** Creates a [[PartialReactionContainer]] with all the reactions from this container,
    * plus a partial [[OnCallbackQuery]] reaction.
    *
  ...
  /** Creates a [[PartialReactionContainer]] with all the reactions from this container,
    * plus a partial [[OnMessageEdited]] reaction that matches any message.
    *
  ...
  /** Creates a [[PartialReactionContainer]] with all the reactions from this container,
    * plus a partial [[OnMessageEdited]] reaction that matches a single message.
    *
  ...
  /** Creates a [[PartialReactionContainer]] with all the reactions from this container,
    * plus a partial [[OnMessageEdited]] reaction that matches a list of messages.
    *
  ...
  /** Creates a [[PartialReactionContainer]] with all the reactions from this container,
    * plus a partial [[OnMatch]] reaction.
    *
  ...
  /** Creates a [[PartialReactionContainer]] with all the reactions from this container,
    * plus a partial [[OnMessagePinned]] reaction.
    *
  ...
  /** Creates a [[PartialReactionContainer]] with all the reactions from this container,
    * plus a partial [[OnChatEnter]] reaction.
    *
  ...
  /** Creates a [[PartialReactionContainer]] with all the reactions from this container,
    * plus a partial [[OnChatLeave]] reaction.
    *
